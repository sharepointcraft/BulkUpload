...
const NewList: React.FC<INewListProps> = ({ context }) => {
  ...
  // const createSharePointList = async (siteUrl: string, listName: string, tableHeaders: string[], columnTypes: string[], setErrorPopupMessage: React.Dispatch<React.SetStateAction<string>>, setIsPopupOpen: React.Dispatch<React.SetStateAction<boolean>>, getRequestDigest: () => Promise<string>): Promise<boolean> => {
